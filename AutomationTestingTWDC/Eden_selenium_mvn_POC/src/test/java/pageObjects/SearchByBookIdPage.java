...
public class SearchByBookIdPage {
    ...
    {
		//element = driver.findElement(By.xpath(".//*[@id='BookingID']"));
	...
	public static WebElement btn_ClearSearch(WebDriver driver)
    {
        //element = driver.findElement(By.name("EdenSearchFields_pyDisplayHarness_27"));
		element = driver.findElement(By.xpath(".//*[@id='RULE_KEY']/div[2]/div/div/div[4]/div/div/span/button"));
        return element;
    }
